...
Plugin::Descriptor PLUGIN_EXPORT eq2_plugin_descriptor =
{
	STRINGIFY( PLUGIN_NAME ),
	"Spacial Equalizer",
	QT_TRANSLATE_NOOP( "pluginBrowser", "A large native eq plugin" ),
	"Dave French & Quentin Faidide <contact/dot/dave/dot/french3/at/googlemail/dot/com> <quentin/at/faidide/dot/fr>",
	0x0100,
	Plugin::Effect,
...
EqEffect::EqEffect( Model *parent, const Plugin::Descriptor::SubPluginFeatures::Key *key) :
	Effect( &eq2_plugin_descriptor, parent, key ),
	m_eqControls( this ),
	m_inGain( 1.0 ),
	m_outGain( 1.0 )
{
